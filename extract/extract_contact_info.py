...
def extract(ciip_book, cursor, application_id, operator_id, facility_id):
    ...
    for a in addresses:
        cursor.execute('''insert into ciip_2018_load.address (application_id, facility_location_id, facility_mailing_id,
    ...
    psycopg2.extras.execute_values(
        cursor,
        '''insert into ciip_2018_load.contact (application_id, application_co_id, address_id,
